...
const LanguagesKnown = () => (
  <div className=" p- mt-4 mb-10">
    <h3 className=" p-1 text-4xl font-bold mb-7 text-center bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent  flex justify-center items-center"> <Globe className="" /> Languages Known</h3>
