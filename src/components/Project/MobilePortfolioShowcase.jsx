	...
	const projects = [
		{
			...
			description: "Real-time IMAP-based onebox email system with search, AI categorization, Slack/webhook alerts, a frontend UI, and AI-powered reply suggestions.",
			image: '/assets/emailproject.png',
			tech: ["TypeScript", "Node.js", "Elasticsearch", "AI/ML Integration", "Docker" ],
			date: "2025",
			category: ["Web Application"],
			liveUrl: "https://youtu.be/fs5SkBAUXMQ",
			githubUrl: "#",
			features: [
				"Real-Time Email Synchronization",
				"Searchable Storage using Elasticsearch",
				"AI-Based Email Categorization",
				"Slack & Webhook Integration",
				"AI-Powered Suggested Replies (Direct invitation to final interview)",
				"RAG (Retrieval-Augmented Generation) with any LLM to suggest replies."
			]
		},
		{
			id: 3,
